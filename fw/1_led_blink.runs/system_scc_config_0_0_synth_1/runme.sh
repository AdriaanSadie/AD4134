...
HD_PWD='C:/Users/adria/OneDrive/Documents/Adriaan/Werk Goedjies/BTT/fw/redpitaya_guide/tmp/1_led_blink/1_led_blink.runs/system_scc_config_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_scc_config_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_scc_config_0_0.tcl
