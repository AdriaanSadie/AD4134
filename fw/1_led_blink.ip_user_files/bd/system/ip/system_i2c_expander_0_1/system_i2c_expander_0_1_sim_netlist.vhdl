...
--               Goedjies/BTT/fw/btt_sccv2_fw/fw/1_led_blink.gen/sources_1/bd/system/ip/system_i2c_expander_0_1/system_i2c_expander_0_1_sim_netlist.vhdl}
...
entity system_i2c_expander_0_1_i2c_expander is
  port (
    ...
    i2c_ack_flag_reg_0 : out STD_LOGIC;
    sda : out STD_LOGIC;
    scl : out STD_LOGIC;
    clk_in : in STD_LOGIC;
    rstn : in STD_LOGIC;
...
architecture STRUCTURE of system_i2c_expander_0_1_i2c_expander is
  ...
  signal i2c_ctrl_addr_reg : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \i2c_ctrl_addr_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_ctrl_addr_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_ctrl_addr_reg[2]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_ctrl_addr_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_ctrl_addr_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_ctrl_addr_reg[5]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_ctrl_addr_reg[6]_i_1_n_0\ : STD_LOGIC;
  ...
  signal i2c_data_reg : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \i2c_data_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_data_reg[1]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_data_reg[2]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_data_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_data_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_data_reg[5]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_data_reg[6]_i_1_n_0\ : STD_LOGIC;
  ...
  signal i2c_opcode_reg_0 : STD_LOGIC;
  ...
  signal i2c_shift_reg_counter : STD_LOGIC;
  signal \i2c_shift_reg_counter[0]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_shift_reg_counter[1]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_shift_reg_counter[2]_i_1_n_0\ : STD_LOGIC;
  signal \i2c_shift_reg_counter[2]_i_2_n_0\ : STD_LOGIC;
  ...
  signal i2c_write_stop_flag_1 : STD_LOGIC;
  ...
  signal sda_out_tristate_oe_reg_i_5_n_0 : STD_LOGIC;
  signal sda_out_tristate_oe_reg_i_6_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \i2c_clk_counter[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \i2c_clk_counter[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[4]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[5]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \i2c_ctrl_addr_reg[6]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \i2c_data_reg[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \i2c_data_reg[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \i2c_data_reg[3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \i2c_data_reg[4]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \i2c_data_reg[5]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \i2c_data_reg[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \i2c_data_reg[7]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \i2c_opcode_reg[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \i2c_opcode_reg[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \i2c_shift_reg_counter[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \i2c_write_tracker[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \i2c_write_tracker[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \i2c_write_tracker[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \i2c_write_tracker[3]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of scl_write_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of sda_INST_0_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_INST_0_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_out_tristate_oe_i_7 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of sda_write_i_2 : label is "soft_lutpair1";
begin
  i2c_clk <= \^i2c_clk\;
  rstn_0 <= \^rstn_0\;
FSM_sequential_i2c_state_i_1: unisim.vcomponents.LUT6
    generic map(
...
i2c_clk_i_1: unisim.vcomponents.LUT6
    generic map(
...
i2c_clk_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\i2c_data_reg[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\i2c_data_reg[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\i2c_shift_reg_counter[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00FFFE00"
    )
        port map (
...
\i2c_shift_reg_counter[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\i2c_shift_reg_counter[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
sda_out_tristate_oe_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B888B8BB"
    )
        port map (
...
sda_out_tristate_oe_reg_i_5: unisim.vcomponents.MUXF7
     port map (
...
sda_out_tristate_oe_reg_i_6: unisim.vcomponents.MUXF7
     port map (
...
sda_write_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"C800"
    )
        port map (
