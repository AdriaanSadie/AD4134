        ...
        if rstn = '0' then
            ...
            case setup_state is
                ...
                when ODRCONFIG =>
                    ...
                    if ODR_COUNT >= 1 then
                        case ODR_COUNT is
                            ...
                            when 5 =>
                                ODR_COUNT <= ODR_COUNT - 1;
                                spiaddr_i <= '1' & ODR_VAL_INT_MSB(6 downto 0); --Write bit msb
                                datain_i  <= ODR_VAL_INT(23 downto 16); --All channels enabled, LDO powered, Sleep mode disabled
                            when 6 =>
                                ODR_COUNT <= ODR_COUNT - 1;
                                spiaddr_i <= '1' & ODR_VAL_INT_MID(6 downto 0); --Write bit msb
                ...
                when ODRCHANNEL =>
                    ...
                    spiaddr_i <= '1' & CHANNEL_ODR_SELECT(6 downto 0); --Write bit msb
                ...
                when DEVICECONFIG_0 =>
                    ...
                    spiaddr_i <= '1' & DEVICE_CONFIG(6 downto 0); --Write bit msb
                ...
                when DEVICECONFIG_1 =>
                    ...
                    spiaddr_i <= '1' & DEVICE_CONFIG_1(6 downto 0); --Write bit msb
                    datain_i  <= "00000000";
                ...
                when DATAPACKETCONFIG =>
                    ...
                    spiaddr_i <= '1' & DATA_PACKET_CONFIG(6 downto 0); --Write bit msb
                    datain_i  <= "00100000";
                ...
                when DIGITALINTERFACECONFIG =>
                    ...
                    spiaddr_i <= '1' & DIGITAL_INTERFACE_CONFIG(6 downto 0); --Write bit msb
                ...
                when FILTERCONFIG =>
                    ...
                    spiaddr_i <= '1' & CHAN_DIG_FILTER_SEL(6 downto 0); --Write bit msb
                ...
                when GPIOCONFIG =>
                    ...
                    spiaddr_i <= '1' & GPIO_DIR_CTRL(6 downto 0); --Write bit msb
                ...
                when ADRESET =>
                    ...
                    spiaddr_i <= '1' & INTERFACE_CONFIG_A(6 downto 0); --Write bit msb
