...
#
#set_property PACKAGE_PIN G17 [get_ports {exp_p_tri_io[0]}] -- sclk
#set_property PACKAGE_PIN G18 [get_ports {exp_n_tri_io[0]}] -- mosi
#set_property PACKAGE_PIN H16 [get_ports {exp_p_tri_io[1]}] -- miso
#set_property PACKAGE_PIN H17 [get_ports {exp_n_tri_io[1]}] -- cs0
#set_property PACKAGE_PIN J18 [get_ports {exp_p_tri_io[2]}] -- cs1
#set_property PACKAGE_PIN H18 [get_ports {exp_n_tri_io[2]}] -- cs2
#set_property PACKAGE_PIN K17 [get_ports {exp_p_tri_io[3]}] --cs3
...
set_property SLEW SLOW [get_ports {led_hb}]
set_property DRIVE 8 [get_ports {led_hb}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {ad5270_sclk}]
set_property IOSTANDARD LVCMOS33 [get_ports {ad5270_mosi}]
set_property IOSTANDARD LVCMOS33 [get_ports {ad5270_miso}]
set_property IOSTANDARD LVCMOS33 [get_ports {ad5270_cs[*]}]
set_property SLEW SLOW [get_ports {ad5270_sclk}]
set_property SLEW SLOW [get_ports {ad5270_mosi}]
set_property SLEW SLOW [get_ports {ad5270_miso}]
set_property SLEW SLOW [get_ports {ad5270_cs[*]}]
set_property DRIVE 12 [get_ports {ad5270_sclk}]
set_property DRIVE 12 [get_ports {ad5270_mosi}]
set_property DRIVE 12 [get_ports {ad5270_miso}]
set_property DRIVE 12 [get_ports {ad5270_cs[*]}]
set_property PULLTYPE PULLUP [get_ports {ad5270_cs[*]}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {gain_ctrl_2_1_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gain_ctrl_2_0_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {switch_1_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {switch_2_0}]
#set_property IOSTANDARD LVCMOS33 [get_ports {n_enable_switch_0}]
...
#set_property PACKAGE_PIN L15 [get_ports {gain_ctrl_2_1_0}]
#set_property PACKAGE_PIN L16 [get_ports {gain_ctrl_2_0_0}]
#set_property PACKAGE_PIN L17 [get_ports {switch_1_0}]
#set_property PACKAGE_PIN K16 [get_ports {switch_2_0}]
#set_property PACKAGE_PIN J16 [get_ports {n_enable_switch_0}]
#set_property PACKAGE_PIN M14 [get_ports {led_2_0}]
#set_property PACKAGE_PIN M15 [get_ports {led_1_0}]
