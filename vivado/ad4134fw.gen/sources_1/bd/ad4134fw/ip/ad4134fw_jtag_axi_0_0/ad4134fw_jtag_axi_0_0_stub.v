...
// Command     : write_verilog -force -mode synth_stub -rename_top ad4134fw_jtag_axi_0_0 -prefix
//               ad4134fw_jtag_axi_0_0_ ad4134fw_jtag_axi_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "ad4134fw_jtag_axi_0_0,jtag_axi_v1_2_20_jtag_axi,{}" *) (* core_generation_info = "ad4134fw_jtag_axi_0_0,jtag_axi_v1_2_20_jtag_axi,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=jtag_axi,x_ipVersion=1.2,x_ipCoreRevision=20,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,RD_TXN_QUEUE_LENGTH=1,WR_TXN_QUEUE_LENGTH=1,M_AXI_ID_WIDTH=1,M_AXI_ADDR_WIDTH=32,FAMILY=virtexu,M_AXI_DATA_WIDTH=32,M_HAS_BURST=1,PROTOCOL=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "jtag_axi_v1_2_20_jtag_axi,Vivado 2024.2" *) 
module ad4134fw_jtag_axi_0_0(aclk, aresetn, m_axi_awid, m_axi_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 signal_clock CLK" *) (* x_interface_mode = "slave signal_clock" *) (* x_interface_parameter = "XIL_INTERFACENAME signal_clock, ASSOCIATED_BUSIF M_AXI, ASSOCIATED_RESET aresetn, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /Processing_Subsystem/clk_wiz_0_clk_out1, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
